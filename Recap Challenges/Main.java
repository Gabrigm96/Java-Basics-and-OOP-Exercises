...
public class Main {
    ...
    public static double exercise2(String mealType, double weight, double expectedScore) {
        ...
        if(mealType.contains("sandwich")) yourMealScore = weight * 5;

        if(mealType.contains("soup")) yourMealScore = weight * 3;

        if(mealType.contains("pasta")) yourMealScore = weight * 3 + 2;
